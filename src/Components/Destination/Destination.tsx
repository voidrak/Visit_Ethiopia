...
const Destination = () => {
  ...
  // const indexMul = window.innerWidth < 1330 ? 94 : 90;
  let indexMul: number;
  if (windowSize <= 1200) {
    indexMul = 94;
  ...
  const mappedItems = destinations.map((card: data) => (
    <div
      className="slider-card relative  mx-auto rounded-[30px] flex flex-col h-[555px] justify-end min-w-[300px] min-[373px]:min-w-[355px] max-w-[356px]  after:absolute  after:bg-gradient-to-b from-transparent to-[#161b23] after:w-full after:h-full after:top-0 after:left-0 after:-z-10 after:rounded-[30px] border border-gray-700 "
      key={card.name}
      style={{
  ...
  return (
    <div className="mt-16    mx-auto">
      <div className="controls-btn  px-4  flex justify-between items-center">
        <div className="filter-btn space-x-8">
          ...
          >
            <h3 className="font-semibold text-xl">All</h3>
          </button>
          <button
          ...
          >
            <h3 className="font-semibold text-xl">Near By</h3>
          </button>
        </div>
        ...
        <div className="swipe-btn   flex gap-x-4 mr-2">
          <button>
            <img
              ...
              alt="pervious arrow"
              className="pervious-arrow  w-[50px]"
              onClick={() => {
      ...
      <h1 className="card-title mt-8 mb-8 ml-2 font-extrabold tracking-widest text-3xl">
        Popular Destination
      </h1>
