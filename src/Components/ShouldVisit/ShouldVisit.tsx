const ShouldVisit = () => {
  return (
    <div className="w-screen  flex  justify-center flex-col h-screen overflow-x-hidden pr-3 bg-[url('images/should_visit_BG.png')] bg-cover bg-no-repeat mt-16 after:absolute after:top-0 after:left-0 after:bg-gradient-to-br from-transparent to-[#212730] after:-z-[1] isolate relative after:w-full after:h-full   min-[373px]:pr-4   ">
